    ...
    if (isUploading) {
      ...
      if (existingUser) {
        ...
        if (
          ...
          let countrycodeSplit = await countrycode.options[
            countrycode.selectedIndex
          ].text.split("(");
          ...
          try {
            ...
            if (signupResponse.data.success === true) {
              ...
              if (taskCode.value === "") {
                ...
                let assignmentID =
                  assignmentResponse.data.assignmentData[0]._id;
          ...
          >
            <Stack spacing={6}>
              ...
              <VStack alignItems={"left"}>
                ...
                <Wrap flexWrap={true} direction={"row"} spacing={1.5}>
                  <Button
                    id="High School"
                    display={"inline-flex"}
                    fontSize={"sm"}
              ...
              <Select
                ...
                id="callbacktime"
                display={!existingUser ? "flex" : "none"}
              >
                <option value="12:00 AM To 03:00 AM">
                  12:00 AM To 03:00 AM
                </option>
                <option value="03:00 AM To 06:00 AM">
                  03:00 AM To 06:00 AM
                </option>
                <option value="06:00 AM To 09:00 AM">
                ...
                <option value="09:00 PM To 12:00 AM">
