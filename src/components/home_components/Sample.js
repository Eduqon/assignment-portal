                  ...
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        ...
                        <a href={Anthropology} target="_blank">
                          - Anthropology
                        </a>
                      </div>
                    </div>
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={BusinessManagement} target="_blank">
                          - Business Management
                        </a>
                        <a href={BusinessAnalytics} target="_blank">
                          - Business Analytics
                        </a>
                        <a href={BusinessEthics} target="_blank">
                          - Business Ethics
                        </a>
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={Criminology} target="_blank">
                          - Criminology
                        </a>
                        <a href={ComputerScience} target="_blank">
                          - Computer Science
                        </a>
                        <a href={ChildcareandPedagogy} target="_blank">
                          - Childcare & Pedagogy
                        </a>
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={Economics} target="_blank">
                          - Economics
                        </a>
                        <a href={EnglishCommorLiterature} target="_blank">
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={Geography} target="_blank">
                          - Geography
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        ...
                        <a href={HumanResourceManagement} target="_blank">
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={OperationsManagement} target="_blank">
                          - Operations Management
                        </a>
                        <a href={OrganisationalBehaviour} target="_blank">
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={Psychology} target="_blank">
                          - Psychology
                        </a>
                        <a href={PoliticalScience} target="_blank">
                          - Political Science
                        </a>
                        <a href={ProjectManagement} target="_blank">
                          - Project Management
                        </a>
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={Sociology} target="_blank">
                          - Sociology{" "}
                        </a>
                  ...
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        ...
                        <a href={TaxationorPayroll} target="_blank">
                          - Taxation/Payroll
                        </a>
                      </div>
                    </div>
                ...
                <div className="col-md-4 col-12 d-flex justify-content-center align-items-start mob-m">
                  <div className="conten">
                    <div className="tab-row">
                      ...
                      <div className="listt">
                        <a href={WorldReligions} target="_blank">
                          - World Religions
                        </a>
                      </div>
                    </div>
