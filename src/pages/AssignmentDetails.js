        ...
        <ModalContent>
          ...
          <ModalBody>
            <InputGroup flexDirection={"column"}>
              ...
              <Textarea id="reworkComment"></Textarea>
            </InputGroup>
          </ModalBody>
          <ModalFooter>
            <Button
      ...
      return (
        <VStack alignItems={"start"} margin={5}>
          ...
          <HStack>
            ...
            <Button
              visibility={
                assignment.status === "CP2 Done" ? "visible" : "hidden"
              }
              color={"red"}
          ...
          <HStack>
            <Box
              visibility={salesId !== undefined ? "visible" : "hidden"}
              borderWidth="1px"
              borderRadius="md"
              width={"xl"}
            >
              ...
              >
                ...
                <InputGroup>
                  <Input type="text" id="addSalesChat" />
                  <Input
                    type="file"
                      ...
                      onClick={async () => {
                        ...
                        if (
                          ...
                          if (Regex.test(textInput.value)) {
                            window.alert(
                              "You are not allowed to share phone numbers in the chat"
                            );
                          } else {
                            const message = await updateDoc(
                              doc(
